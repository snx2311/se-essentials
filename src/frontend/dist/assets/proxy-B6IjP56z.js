...
import { m as ProtocolError, T as TimeoutWaitingForResponseErrorCode, p as utf8ToBytes, E as ExternalError, q as MissingRootKeyErrorCode, C as Certificate, t as lookupResultToBuffer, R as RequestStatusResponseStatus, U as UnknownError, w as RequestStatusDoneNoReplyErrorCode, x as RejectError, y as CertifiedRejectErrorCode, z as UNREACHABLE_ERROR, I as InputError, A as InvalidReadStateRequestErrorCode, B as ReadRequestType, D as Principal, F as IDL, G as MissingCanisterIdErrorCode, J as HttpAgent, K as encode, Q as QueryResponseStatus, N as UncertifiedRejectErrorCode, O as isV3ResponseBody, V as isV2ResponseBody, W as UncertifiedRejectUpdateErrorCode, X as UnexpectedErrorCode, Y as decode, g as Subscribable, Z as pendingThenable, _ as resolveEnabled, s as shallowEqualObjects, $ as resolveStaleTime, k as noop$1, a0 as environmentManager, a1 as isValidTimeout, a2 as timeUntilStale, a3 as timeoutManager, a4 as focusManager, a5 as fetchState, a6 as replaceData, n as notifyManager, r as reactExports, l as shouldThrowError, e as useQueryClient, f as useInternetIdentity, a7 as createActorWithConfig, a8 as Variant, a9 as Record, aa as Opt, ab as Service, ac as Func, ad as Vec, ae as Nat, af as Text, ag as Bool, ah as Float64, ai as Null, aj as Principal$1, ak as Int, j as jsxRuntimeExports, al as React, am as clsx, b as cn } from "./index-DHY5Q3pY.js";
...
Service({
  ...
  "adminUpdateStock": Func([ProductId, Bool], [], []),
  "getMyMembership": Func([], [MemberTier$1], ["query"]),
  ...
  "placeOrder": Func(
    [ProductId, Nat, Text, Text],
    [Order],
    []
  ),
  "removeFromWishlist": Func([ProductId], [], []),
  "upgradeMembership": Func([MemberTier$1], [], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  const ProductId2 = IDL2.Nat;
  const Category2 = IDL2.Variant({
    "DigitalArt": IDL2.Null,
    "DesignerGoods": IDL2.Null
  });
  const MemberTier2 = IDL2.Variant({
    "Elite": IDL2.Null,
    "Executive": IDL2.Null,
    "Standard": IDL2.Null
  });
  const Product2 = IDL2.Record({
    ...
    "imageUrl": IDL2.Text,
    "distanceKm": IDL2.Float64,
    "category": Category2,
    "rating": IDL2.Nat,
    "cryptoPrice": IDL2.Opt(IDL2.Text),
    "price": IDL2.Nat,
    "reviewCount": IDL2.Nat,
    "tierRequired": MemberTier2
  });
  ...
  const Order2 = IDL2.Record({
    ...
    "buyer": IDL2.Principal
  });
  return IDL2.Service({
    "addToWishlist": IDL2.Func([ProductId2], [], []),
    "adminAddProduct": IDL2.Func(
      [
        IDL2.Text,
        IDL2.Text,
        Category2,
    ...
    "adminUpdateStock": IDL2.Func([ProductId2, IDL2.Bool], [], []),
    "getMyMembership": IDL2.Func([], [MemberTier2], ["query"]),
    ...
    "placeOrder": IDL2.Func(
      [ProductId2, IDL2.Nat, IDL2.Text, IDL2.Text],
      [Order2],
      []
    ),
    "removeFromWishlist": IDL2.Func([ProductId2], [], []),
    "upgradeMembership": IDL2.Func([MemberTier2], [], [])
  });
};
...
var Category = /* @__PURE__ */ ((Category2) => {
  Category2["DigitalArt"] = "DigitalArt";
  Category2["DesignerGoods"] = "DesignerGoods";
  return Category2;
})(Category || {});
var MemberTier = /* @__PURE__ */ ((MemberTier2) => {
  MemberTier2["Elite"] = "Elite";
  MemberTier2["Executive"] = "Executive";
  MemberTier2["Standard"] = "Standard";
  return MemberTier2;
})(MemberTier || {});
...
class Backend {
  ...
  async adminAddProduct(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8) {
    if (this.processError) {
      try {
...
function from_candid_MemberTier_n11(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n12(_uploadFile, _downloadFile, value);
}
function from_candid_OrderStatus_n16(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n17(_uploadFile, _downloadFile, value);
}
function from_candid_Order_n14(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n12(_uploadFile, _downloadFile, value) {
  return "Elite" in value ? "Elite" : "Executive" in value ? "Executive" : "Standard" in value ? "Standard" : value;
}
function from_candid_variant_n17(_uploadFile, _downloadFile, value) {
  return "Delivered" in value ? "Delivered" : "Cancelled" in value ? "Cancelled" : "Processing" in value ? "Processing" : "Pending" in value ? "Pending" : value;
}
function from_candid_variant_n9(_uploadFile, _downloadFile, value) {
  return "DigitalArt" in value ? "DigitalArt" : "DesignerGoods" in value ? "DesignerGoods" : value;
}
...
function to_candid_Category_n1(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n2(_uploadFile, _downloadFile, value);
}
function to_candid_MemberTier_n4(_uploadFile, _downloadFile, value) {
